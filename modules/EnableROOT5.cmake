...
macro (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN)
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ...
    COMMAND LD_LIBRARY_PATH=${ROOT_LIBRARY_DIRS} ROOTSYS=${ROOTSYS} ${ROOT_rootcint_CMD}
    ...
    ADD_CUSTOM_COMMAND(
      OUTPUT ${OUTFILES}
      COMMAND DYLD_LIBRARY_PATH=${ROOT_LIBRARY_DIRS} ROOTSYS=${ROOTSYS} ${ROOT_rootcint_CMD}
      ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE}
      DEPENDS ${INFILES} ${LINKDEF_FILE} )
